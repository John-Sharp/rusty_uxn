...
const OP_LIST: &'static [OpDescription] = &[
    ...
    OpDescription{op_code: OpCode::Nip, byte: 0x03, token: "NIP", handler: op_handlers::nip_handler},
    OpDescription{op_code: OpCode::Swp, byte: 0x04, token: "SWP", handler: op_handlers::swp_handler},
    OpDescription{op_code: OpCode::Rot, byte: 0x05, token: "ROT", handler: op_handlers::rot_handler},
    OpDescription{op_code: OpCode::Dup, byte: 0x06, token: "DUP", handler: op_handlers::dup_handler},
    OpDescription{op_code: OpCode::Ovr, byte: 0x07, token: "OVR", handler: op_handlers::ovr_handler},
